...
public:
	...
	//Declaring graphics and bitmaps
	wxImage *imgFlag = new wxImage(wxString("Flag.png"), wxBITMAP_TYPE_PNG);
	wxBitmap *bmpFlag50p = new wxBitmap(imgFlag->Scale(50, 50, wxIMAGE_QUALITY_HIGH));
