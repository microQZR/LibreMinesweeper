...
cMain::cMain() : wxFrame(nullptr, wxID_ANY, "OneLoneCoder.com - wxWidgets!", wxPoint(100, 100), wxSize(600, 665))
{
	...
	wxButton *settingsButton = new wxButton(toolbar1, 10001, "Setings", wxDefaultPosition, wxSize(40,40), 0);
	wxButton *forfeitButton = new wxButton(toolbar1, 10002, "Forfeit", wxDefaultPosition, wxSize(40,40), 0);
	wxButton *restartButton = new wxButton(toolbar1, 10003, "Restart", wxDefaultPosition, wxSize(40,40), 0);
	...
	wxStaticText *SettingsTxt2 = new wxStaticText(SettingsDial, wxID_ANY, wxString("Blah Blah Blah"));
	...
	wxSlider *SettingsSlider = new wxSlider(SettingsDial, 7051, 2, 1, 3, wxDefaultPosition, wxDefaultSize, wxSL_BOTH);
	...
	vboxSettings->Add(SettingsTxt2, 1, wxEXPAND | wxLEFT | wxRIGHT, 30);
	vboxSettings->AddSpacer(15);
	...
	Bind(wxEVT_BUTTON, &cMain::OnClickSettings, this, 10001);
	Bind(wxEVT_BUTTON, &cMain::OnClickForfeit, this, 10002);
	Bind(wxEVT_BUTTON, &cMain::OnClickRestart, this, 10003);
...
cMain::~cMain() {
	delete[] btn;
	delete[] nField; //##//deleting array of mines which was omitted during tutorial
...
{
	wxMessageBox(" HELLOOO BOOOOOM !! - Game Over :(");
}
